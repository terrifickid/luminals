...
<div class="fixed bottom-2 w-full flex justify-center  items-center p-4 z-40">
  <a href="https://discord.com/invite/luminaries">
    <svg
      role="img"
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
      class="fill-gray-500 hover:fill-white w-5 mx-2"
  ...
  <a href="https://twitter.com/Luminariesio">
    <svg
      role="img"
      viewBox="0 0 24 24"
      class="w-5 fill-gray-500 hover:fill-white mx-2"
      xmlns="http://www.w3.org/2000/svg"
  ...
  <a
    ...
    class="   rounded uppercase text-white text-sm mx-7">Mint NFT</a
  >
  ...
  <a href="https://opensea.io/collection/luminariesnft">
    <svg
      role="img"
      viewBox="0 0 24 24"
      class="fill-gray-200 hover:fill-white w-5 mx-2"
      xmlns="http://www.w3.org/2000/svg"
      ><title>OpenSea</title><path
